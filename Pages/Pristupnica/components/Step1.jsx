    ...
    <>
      <View style={{ width: "100%", gap: 10 }}>
        ...
        <TextInput
          ...
          defaultValue={initalValue ? initalValue.name_surname : null}
        ></TextInput>
        {validation.some((item) => item.includes("name_surname")) ? (
          <Text style={{ color: "red" }}>
            Ime i prezime moraju biti duzi od 6 karaktera
          </Text>
        ) : null}
        ...
        <TextInput
          ...
          defaultValue={initalValue ? initalValue.mail : null}
        ></TextInput>
        {validation.some((item) => item.includes("mail")) ? (
          <Text style={{ color: "red" }}>
            Email koji ste unijeli nije važeći{" "}
          </Text>
        ) : null}
