  ...
  return (
    <View style={{ width: "100%", gap: 10 }}>
      ...
      <TextInput
        ...
        defaultValue={initalValue ? initalValue.Town : null}
      ></TextInput>
      {validation.some((item) => item.includes("town")) ? (
        <Text style={{ color: "red" }}>Grad mora biti duze od 6 karaktera</Text>
      ) : null}
      ...
      <TextInput
        ...
        defaultValue={initalValue ? initalValue.Adresa : null}
      ></TextInput>
      {validation.some((item) => item.includes("adresa")) ? (
        <Text style={{ color: "red" }}>
          Adresa mora biti duza od 6 karaktera
        </Text>
      ) : null}
      ...
      <TextInput
        ...
        defaultValue={initalValue ? initalValue.Telefon : null}
      ></TextInput>
      {validation.some((item) => item.includes("telefon")) ? (
        <Text style={{ color: "red" }}>Unesite važeći broj telefona</Text>
      ) : null}
    </View>
  );
}
