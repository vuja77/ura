  ...
  return (
    <View style={{ width: "100%", gap: 10 }}>
      ...
      <TextInput
        ...
        defaultValue={initalValue ? initalValue.Zanimanje : null}
      ></TextInput>
      {validation.some((item) => item.includes("zanimanje")) ? (
        <Text style={{ color: "red" }}>Upišite vaše zanimjane</Text>
      ) : null}
      ...
      <TextInput
        ...
        placeholder="Zelim da doprinesem u oblasti"
        style={{
          borderColor: "#CBCBCB",
          borderWidth: 1,
          padding: 10,
        ...
        defaultValue={initalValue ? initalValue.Doprinos : null}
      ></TextInput>
      {validation.some((item) => item.includes("doprinos")) ? (
        <Text style={{ color: "red" }}>
          Upišite u kojoj oblasti želite doprijeniti
        </Text>
      ) : null}
    </View>
  );
