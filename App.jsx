      ...
      <Provider store={store}>
        <NavigationContainer>
          <Stack.Navigator screenOptions={{
            ...
            <Stack.Screen name='Pristupnica' component={Pristupnica} />
            <Stack.Screen name='Odbor' component={Odbor} options={{headerShown: false}}/>
            <Stack.Screen name="success" component={Success} options={{ title: "Poslato", }} />
          </Stack.Navigator>
        </NavigationContainer>
      </Provider>
    </>
